...
return(
  ...
  <nav style={{backgroundColor:"#333",padding:"10px",display:"flex",justifyContent:"space-between",alignItems:"center"}}>
    ...
    <button style={{color:"#fff",textDecoration:"none",fontSize:"20px",backgroundColor:"red",border:"none",padding:"10px",cursor:"pointer"}} onClick={()=>navigate("/login")}>Logout</button>
  </nav>
    </>
)
}
